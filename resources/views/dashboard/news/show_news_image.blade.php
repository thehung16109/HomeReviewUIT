...
@section('admin_content')
    <div>
        <h3 class="title">Ảnh của tin tức</h3>
        <div class="x_panel">
            <div class="x_content">
                ...
                <div>
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach ($news_images as $key => $image)
                                <tr>
                                    <td>
                                        <label class="i-checks">
                                    ...
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $news_title }}</td>
                                    <td><img src="../uploads/NewsImage/{{$image}}" height="100" width="100">
                                    </td>
                                    <td>
                                        <a onclick="return confirm('Bạn chắc chắn muốn xóa hình ảnh này?')" href="{{URL::to('/delete-news-image/'.$image.'/'.$news_id)}}">
