...
<body>
    <div class="log-w3">
        <div class="w3layouts-main" style="width=85%">
            <div>
            <h1 style="color:#f68a39; font-weight:bold !important">LẤY LẠI MẬT KHẨU</h1>
            </div>
            ...
            <form action="{{route('sendemail')}}" method="post" >
                ...
                <input type="submit" value="Gửi email" name="login">
