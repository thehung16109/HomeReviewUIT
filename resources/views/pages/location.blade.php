            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a class="text-light"
                            style="font-weight:bolder">{{ $location_name }}</a></li>
                </ol>
            </nav>
        </div>
    </section>
                    ...
                    @foreach ($all_review_location as $key => $review_location)
                        <div class="row mb-4 wow bounceInLeft hs-item">
                                ...
                                <a href="{{ URL::to('/review/' . $review_location->review_slug) }}">
                                    ...
                                    <div class="homestay-overlay">
                                        <a class="location-tag"
                                            href="{{ URL::to('/category/' . $review_location->category->category_slug) }}">
                            ...
                            <div class="col-md-7 col-lg-7 col-xl-7">
                                <a class="review-title" href="{{ URL::to('/review/' . $review_location->review_slug) }}">
